# GPU-historien — den tekniske vej til virkende WebGL

Den kronologiske, tekniske fremstilling: målinger, blindgyder og de
præcise kommandoer. Vil du have fortællingen i hverdagssprog, læs
`hvorfor.md` i stedet.
...
seccomp/syscall-403-klasse som §5.5 og docs/faeller.md fælde 14), installeret i qemu-chroot
...
i pædagogisk form: docs/faeller.md fælde 17.
...
have dødd på samme NULL-slot; patchen åbner vejen. Opslagsværket: docs/faeller.md
fælde 18.
