...
- [x] lxterminal som standard i eMMC-imaget (aug 2026) — `devuan/extra_packages.sh` samler ekstra rootfs-pakker i en EXTRA_PACKAGES-liste (pt. kun lxterminal; lxde-core trækker ingen terminal med), bevidst uden om 07 der kun er desktop+lyd. 09's preflight-vagt stopper bygningen hvis pakkerne mangler i rootfs'en
