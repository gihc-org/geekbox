...
**Aktuelt spor:** `devuan/gpu/GPU-FAULT-GENNEMBRUD-SESSION-NOTAT-2026-08-26.md` (GPU-MMU-fault bag WR_POST_UPDATE-reset + precache-shader-determinisme) — opdater denne linje når et nyt spor starter.
