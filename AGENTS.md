...
**Aktuelt spor:** `devuan/gpu/DDK15-1.5-KOMPLET-HANDOVER-2026-08-26.md` (DDK 1.5 kører; Subway Surfers' resterende præsentationsblokade + valg: gralloc-lock-spor / Spor B 4.4+DDK 1.8 / acceptér; næste kernel-byg: CONFIG_ANDROID_PARANOID_NETWORK fra + bcmdhd; NTP-sporet åbent) — opdater denne linje når et nyt spor starter.
