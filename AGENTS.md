...
- Skel eksplicit mellem **aftalt** (skal ind i "Næste skridt" + docs/DOKUMENTATION.md/TODO.md) og **foreslået** (kun idé; må ikke behandles som plan uden brugerens godkendelse).
...
- Når en plan/beslutning ændres, opdatér også TODO.md og docs/DOKUMENTATION.md samme time (korte pointere, ikke dubletter).
...
- Hold notatet kort og kommando-tungt; læg vigtige fakta i repo-filer (`docs/DOKUMENTATION.md` / `docs/HAANDBOG.md`), ikke kun i samtalehistorikken.
